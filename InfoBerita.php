...
class InfoBerita extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_admin, judul, isi_konten', 'required', 'message'=>'{attribute} Tidak Boleh Kosong'),
	...
	{ 
		$sql='SELECT * FROM info_berita order by id_info desc'; 
